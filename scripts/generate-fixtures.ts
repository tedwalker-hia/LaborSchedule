  ...
  // -------------------------------------------------------------------------
  {
    ...
    employees: [
      ...
      },
      {
        ...
        dept: 'Housekeeping',
        position: 'Room Attendant',
        shifts: weekdays(S.morning),
      },
      {
        code: 'GAMMA-004',
        name: 'Robinson, Dorothy',
        dept: 'F&B',
        position: 'Host',
        shifts: sixDay(S.std),
      },
  ...
  // -------------------------------------------------------------------------
  {
    ...
    employees: [
      // Smith appears twice: Server Mon-Wed, Bartender Thu-Sun
      {
        ...
        dept: 'F&B',
        position: 'Server',
        shifts: [S.std, S.std, S.std, null, null, null, null],
      },
      {
        code: 'ALPHA-001',
        name: 'Smith, John',
        dept: 'F&B',
        position: 'Bartender',
        shifts: [null, null, null, S.std, S.std, S.std, null],
      },
      {
        code: 'ALPHA-002',
        name: 'Johnson, Mary',
      ...
      // Garcia cross-trained: Housekeeping + Maintenance
      {
        ...
        dept: 'Housekeeping',
        position: 'Room Attendant',
        shifts: [S.morning, S.morning, S.morning, null, null, null, null],
      },
      {
        code: 'ALPHA-006',
        name: 'Garcia, Linda',
        dept: 'Maintenance',
        position: 'Engineer',
        shifts: [null, null, null, S.std, S.std, null, null],
      },
      {
        code: 'ALPHA-007',
        name: 'Martinez, David',
    ...
    employees: [
      {
        ...
        dept: 'Front Desk',
        position: 'Agent',
        shifts: [S.std, S.std, S.std, S.std, S.std],
      },
      {
        code: 'DELTA-007',
        name: 'Green, Mark',
      ...
      },
      {
        ...
        dept: 'Front Desk',
        position: 'Supervisor',
        shifts: [S.std, null, S.std, null, S.std],
      },
    ],
  },
...
async function buildWorkbook(spec: FixtureSpec): Promise<void> {
  ...
  console.log(
    `  written: ${spec.filename} (${spec.employees.length} employees, ${spec.numDays} days)`,
  );
}
