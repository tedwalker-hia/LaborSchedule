...
export default function GenerateModal({ open, onClose, filters, selectedEmployees, onComplete }: GenerateModalProps) {
  ...
  return (
    <Modal isOpen={open} onClose={handleClose} title={`Generate Schedule (Step ${step}/5)`} size="lg" footer={renderFooter()}>
      {error && step !== 5 && (
